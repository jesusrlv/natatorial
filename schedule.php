...
/*       
    ...
    <body onload="testimonials();locations()">
        ...
        <div class="container mt-3">
            ...
            <div class="row row-cols-1 g-2 mt-5 mb-5">
              ...
              <div class="col-sm-6">
                <div class="card card-cover overflow-hidden text-bg-dark rounded-4 shadow-lg" id="imagenesDesign" style="background-image: url('img/payment_form.png');background-repeat: no-repeat;background-size: 100% 100%;width:100%">
    ...
    <div class="container">
      <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
        <p class="col-md-4 mb-0 text-muted">&copy; 2024 Natatorial.com</p>
    ...
    <div class="modal fade" id="infoCheck2" data-bs-backdrop="static" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
