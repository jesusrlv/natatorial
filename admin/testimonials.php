    ...
    <body>
        ...
        <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
              ...
              <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                <li><a href="dashboard.php" class="icon-link icon-link-hover">LIST ABOUT SCHEDULE</a></li>
            </ul>
            <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                <li><i class="bi bi-circle-fill"></i> TESTIMONIALS</li>
              </ul>
...
<div class="container">
    ...
    <hr>
    <h4 class="text-primary mt-3 mb-4">Testimonials</h4>
    ...
    <div class="table-responsive">
      <table class="table table-striped table-hover">
        ...
        <tbody id="myTable">
          <?php
          include ('prcd/queryTestimonials.php');
          $x = 0;
           while($row_sqlInv = $resultadoBusqueda->fetch_assoc()){
            $x++;
            $idChange = $row_sqlInv['id'];
            $stars = $row_sqlInv['calif'];
            echo'<tr>';
                echo'<td class="text-center">'.$x.'</td>';
                echo'<td class="text-center">'.$row_sqlInv['dateT'].'</td>';
                echo'<td class="text-center">'.$row_sqlInv['testimonial'].'</td>';
                ...
                echo '</td>';
                echo'<td class="text-center"><a href="prcd/deleteTestimonials.php?id='.$row_sqlInv['id'].'" type="button" class="btn btn-danger btn-sm"><i class="bi bi-trash"></i> Delete</button></td>';
